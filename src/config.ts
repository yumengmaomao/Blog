    ...
    links: [
        ...
        // 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
        {
            ...
            children: [
                {
                    name: "GitHub",
                    url: "https://github.com/yumengmaomao",
                    external: true
                },
                {
                    name: "Bilibili",
                    url: "https://space.bilibili.com/148847697",
                    external: true
                },
                {
                    name: "Gitee",
    ...
    links: [
        {
            ...
            url: "https://m.bilibili.com/space/148847697"
        },
        {
            name: "Gitee",
            icon: "mdi:git",
            url: "https://gitee.com/yumengmaomao"
        },
        {
            name: "GitHub",
...
export const announcementConfig: AnnouncementConfig = {
    title: "公告", // 公告标题
    content: "欢迎来到我的博客！看看有什么好玩的内容吧~。", // 公告内容
